...
#     '''Gets the solution for exercise 7'''
#     change_dir()
#     project_path = os.path.join(os.getcwd(), 'my_awesome_folder')
#     venv_path = os.path.join(project_path, 'venv_awesome', 'Scripts')
#     scripts_path = os.path.join(project_path, 'my_awesome_package')
#     print(f"\033[1m\033[94m💡 SOLUTION 💡\033[0m")
#     print('')
#     print('# Commenter la ligne avec ModelTfidfSvm.')
#     print('')
#     print('# Décommenter la ligne avec ModelEmbeddingLstm')
#     print('')
#     print(f"cd {venv_path}")
#     print('')
#     print(f"activate")
#     print('')
#     print(f"(venv_awesome) cd {scripts_path}")
#     print('')
#     print(f"(venv_awesome) python 0_get_embedding_dict.py -f cc.fr.300.vec")
#     print('')
#     print(f'(venv_awesome) python 2_training.py --filename dataset_jvc_train.csv --x_col description --y_col "Action" "Aventure" "RPG" "Plate-Forme" "FPS" "Course" "Stratégie" "Sport" "Réflexion" "Combat" --filename_valid dataset_jvc_valid.csv')
#     print('')
#     print(f"\033[1m\033[94m💡 SOLUTION 💡\033[0m")


# def get_exercice_8_solution():
